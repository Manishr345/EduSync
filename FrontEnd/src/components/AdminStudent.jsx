...
const AdminStudent = () => {
    ...
    return (
        <>
            <div className="flex justify-center items-center h-screen min-[319px]:max-[500px]:p-[10vw]  ">
                <div className="flex justify-center items-center rounded-3xl gap-16 border w-[40rem] h-[20rem] bg-[#021D3C] shadow-none transition-all duration-500 cursor-pointer   hover:shadow-[-6px_-6px_15px_#0ea5e9] min-[319px]:max-[500px]:flex-col  min-[319px]:max-[500px]:gap-7 min-[319px]:max-[500px]:h-[25rem]">
                    ...
                    <div className="mx-5 flex justify-center items-center p-5 rounded-2xl  hover:bg-[#02264F]">
                        <button onClick={adminhandleClick} className="border-none bg-none cursor-pointer flex flex-col justify-center items-center">
