  ...
  <Header/>
    <div className='w-[100%] flex justify-center '>
      <div className="w-[95%] about-page ">
        <section className="py-10 bg-gray-900 text-white rounded-lg">
        ...
        <section className="py-10 bg-gray-900 text-white mt-8 rounded-lg">
          <div className="container mx-auto">
        ...
        <section className="py-10 bg-gray-900 text-white mt-8 mb-8 rounded-lg">
